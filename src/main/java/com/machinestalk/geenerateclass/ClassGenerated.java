...
public class ClassGenerated {
    ...
    public  void testing(SetupDTO setupDTO) throws Exception {
        ...
        classWriter.visit(Opcodes.V17, Opcodes.ACC_PUBLIC | Opcodes.ACC_SUPER, "com/machinestalk/geenerateclass/"+setupDTO.getName(), null, "io/gatling/javaapi/core/Simulation", null);
        // Create constructeur()
...
//**
        ...
        saveToFileInTargetDirectory(getTargetDirectoryPath()+"\\classes\\com\\machinestalk\\geenerateclass", setupDTO.getName()+".class", classBytes);
